...
// CLAUDE_CONTEXT.md).
// Utökad 2026-08-18 från 51 till ~105 modeller — se CLAUDE_CONTEXT.md för
// bakgrund. Källor: carup.se (Sveriges 100 populäraste bilar, nyregistreringar
// 2024) korsat mot Kvdbils faktiska begagnatförsäljningsstatistik 2025 (den
// senare avslöjade att Volvo V70 — utgången sedan 2016 — fortfarande är
// Sveriges mest sålda BEGAGNADE bil, ett resultat nyregistrerings­listan helt
// missar). Skåpbilar/lätta lastbilar (Ducato, Sprinter, Transit, Caddy,
// Transporter, Vito) är medvetet uteslutna — utanför scope för en
// personbils­annons-analystjänst.
